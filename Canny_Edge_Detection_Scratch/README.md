...
1. **Noise reduction.** To remove noise, the image is smoothed by Gaussian blur with the $\sigma = 1.4$. The sum of the elements in the Gaussian kernel equals $1$. <br><br>
